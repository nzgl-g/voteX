...
export function VoterHeader() {
  ...
  // Only render this header in the voter page
  if (!pathname.includes('/voter')) {
    return null;
  }
  ...
  return (
    <motion.header
      ...
      className="mb-4 sticky top-4 z-50 mx-auto w-full container rounded-md bg-background/80 shadow-lg backdrop-blur-md flex items-center justify-between px-4 py-2 border border-border transition-all"
    ...
    >
      ...
      <div className="flex items-center gap-2 bg-muted/40 rounded-lg px-2 py-1 transition-all">
