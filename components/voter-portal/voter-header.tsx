...
export function VoterHeader() {
  ...
  return (
    <motion.header
      ...
      className="mb-4 sticky top-4 z-50 mx-auto w-full max-w-4xl sm:max-w-5xl lg:max-w-6xl rounded-full bg-background/80 shadow-lg backdrop-blur-md flex items-center justify-between px-4 py-2 border border-border transition-all"
